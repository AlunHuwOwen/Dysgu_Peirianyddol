...
Yn y graff yn Narlun~\ref{fig:dullpenelin}, gwelwn fod swm sgwariau yn fawr yn cychwyn gyda $k$=1 sydd yn gwneud synnwyr gan fod allanolion o unrhyw set yn cyfrannu i werth fawr o'r swm sgwariau gan ein fod methu cael ei ystyried pan does dim on un craidd i'w sortio.
...
I wneud fwy o synnwyr o'r data, mi wnawn blotio'r data. Defnyddiwn \mintinline{R}{pch=21} i newid y pwyntiau ar y plot i alluogi lliwiau (ar gyfer y labeli hwyrach ymlaen).
...
Mae'r string sydd mewnbwn y ffwythiant \mintinline{python}{pd.read_csv} yn cyfeirio at y lleoliad ar ein cyfrifiadur lle gallwn ganfod y ffeil csv priodol. Rhaid gwneud yn si\^{w}r eich bod yn defnyddio'r lleoliad cywir i'r lleoliad o'ch ffeil chi.
