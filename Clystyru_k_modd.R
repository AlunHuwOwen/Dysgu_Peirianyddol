...
library(stats)
library(datasets)
taldrapwysau <- read.csv("C:/Users/User/Desktop/Dysgu_Peirianyddol/taldra-pwysau.csv")
...
plot(Taldra, Pwysau, pch = 21, bg=c("red","green","blue", "yellow", "black", "white")[unclass(kcymedr$cluster)])
taldrapwysau$Clwstwr6 <- kcymedr$cluster 
View(taldrapwysau)

#Darn gweledol o clystyru k-cymedr

uchderpwysau <- read.csv("C:/Users/User/Desktop/Dysgu_Peirianyddol/taldra-pwysau.csv")
attach(uchderpwysau)
plot(Taldra, Pwysau )
xclwstwr <- runif(n = 3, min = min(Taldra), max = max(Taldra))
...
plot(Taldra, Pwysau, pch=20, col = c("red","green", "Blue")[unclass(cychwynol)])
...
plot(Taldra, Pwysau)
points(matrix(c(q1,q2,q3), nrow = 3, ncol = 2, byrow = TRUE), pch = 20, col = c("red","green", "Blue"), cex = 2)
z1 <- c()
z2 <- c()
z3 <- c()
for (i in 1:175)
...
plot(Taldra, Pwysau, pch = 20, col=c("red","green","blue")[unclass(clwstwrn)])
clwstwrn
...
plot(Taldra, Pwysau, pch = 1)
points(cyntaf, pch = 20, col = c("red","green", "Blue"), cex = 2)
points(ail, pch = 20, col = c("red","green", "Blue"),cex = 1.75)
points(trydydd, pch = 20, col = c("red","green", "Blue"), cex = 1.5)
points(pedwerydd, pch = 20, col = c("red","green", "Blue"), cex = 1.25)
points(pumed, pch = 20, col = c("red","green", "Blue"), cex = 1)
points(chweched, pch = 20, col = c("red","green", "Blue"), cex = 0.75)
lines(matrix(c(cyntaf[1,],ail[1,],trydydd[1,],pedwerydd[1,],pumed[1,],chweched[1,]), nrow = 6, ncol = 2, byrow = TRUE), col = "red", pch = 5 )
lines(matrix(c(cyntaf[2,],ail[2,],trydydd[2,],pedwerydd[2,],pumed[2,],chweched[2,]), nrow = 6, ncol = 2, byrow = TRUE), col = "green", pch = 5 )
